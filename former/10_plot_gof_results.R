...
### List all models
model_list <- paste0("apr_model_", pred_list)

### List all input (observed or reconstructed)
input_list <- c("observ_annual", "rec_local")
...
reconst_location <- file.path(weber_output_path, paste0(var_folder, "/",site_id,"_",Var1, "_reconst_ts_",Var2,".csv"))
...
dir.create(write_figures_path, showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_full"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_full/png"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_full/svg"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_full/pdf"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_subset"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_subset/png"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_subset/svg"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "ts_subset/pdf"), showWarnings = FALSE)
...
dir.create(file.path(write_figures_path, "resid_full"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "resid_full/png"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "resid_full/svg"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "resid_full/pdf"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "resid_monthly"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "resid_monthly/png"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "resid_monthly/svg"), showWarnings = FALSE)
dir.create(file.path(write_figures_path, "resid_monthly/pdf"), showWarnings = FALSE)
