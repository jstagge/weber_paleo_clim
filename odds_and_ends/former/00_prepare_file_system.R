...
### Install monthly paleo functions
library(devtools)
install_github("jstagge/monthlypaleo")
...
dir.create(weber_output_path)

dir.create(file.path(weber_output_path, "figures"))
dir.create(file.path(weber_output_path, "gof"))
dir.create(file.path(weber_output_path, "observed_flow"))
dir.create(file.path(weber_output_path, "pca_chronol"))
dir.create(file.path(weber_output_path, "paleo_reconst"))
