...
weber_cc_melt_df <- data.frame(weber_cc_melt)
weber_cc_melt_df <- data.frame(site_id=site_id, site=site_name, year=weber_cc_melt_df$year, month=weber_cc_melt_df$mo, date=weber_cc_melt_df$date, monthly_mean=weber_cc_melt_df$value, month_perc=weber_cc_melt_df$month_perc, data=weber_cc_melt_df$variable)

weber_cc_melt_df$data <- as.character(weber_cc_melt_df$data)
weber_cc_melt_df$data[weber_cc_melt_df$data == "base"] <- "observed"

head(weber_cc_melt_df)
...
write.csv(weber_cc_melt_df, file = write_location, row.names=FALSE)
